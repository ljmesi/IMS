...
(0.833333, 1, "large puppy",0),
(1, 1.166667, "large puppy",0),
(1.66667, 1.3333333 , "large puppy",0),
(1.3333333, 1.5, "large puppy",0),
(1.5, 2, "large puppy",0),
(0.833333, 8, "adult small - medium dog",0),
...
ALTER TABLE age_activity_diet_health ADD COLUMN amount_percent decimal;