          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a target="_blank" href="../pet-feeder-app/public/pages/sign-in.php" title="link to sign in page">Sign in</a></li>
                <li><a href="../pet-feeder-app/public/pages/sign-up.php" title="link to sign up page">Sign up</a></li>
                <li role="separator" class="divider"></li>
                <li><a target="_blank" href="../pet-feeder-app/public/pages/log-out.php" title="link to log out page">Log out</a></li>
              </ul>
            </li>
          </ul>
        </div>
